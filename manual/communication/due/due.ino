...
int encoderPin11 = 32;//6
int encoderPin12 = 33;//6
...
attachInterrupt(32, updateEncoder6, CHANGE); 
  attachInterrupt(33, updateEncoder6, CHANGE);
...
void forwardd()
{
  ...
  encoderValue1=encoderValue2=encoderValue3=encoderValue4=0;
        ...
        while((abs(encoderValue1)<12000)|(abs(encoderValue2)<12000)|(abs(encoderValue3)<12000)|(abs(encoderValue4)<12000))
        {
          ...
          {
            analogWrite(2,0);
//         if(abs(encoderValue1)<12000)
//         {analogWrite(2,50);
//         delay(100);}
//         else
//         analogWrite(2,0);
          if(abs(encoderValue2)<12000)
         {analogWrite(3,50);
         delay(100);
         }
          else
         analogWrite(3,0);
          if(abs(encoderValue3)<12000)
         {analogWrite(4,50);
         delay(100);}
          else
         analogWrite(4,0);
          if(abs(encoderValue4)<12000)
         {analogWrite(5,50);
         delay(100);}
          else
         analogWrite(5,0);
