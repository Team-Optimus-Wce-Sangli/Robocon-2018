...
//   analogWrite(pwm5,sp);
//  digitalWrite(dir5,1);
//  if(abs(encoderValue6)<1980&abs(encoderValue6)>1940&val<1980&val>1960)
// { 
...
void loop() {
    ...
    //Serial.println(encoderValue1);Serial.print(",");Serial.print(encoderValue2);Serial.print(",");Serial.print(encoderValue3);Serial.print(",");Serial.print(encoderValue4);
      ...
      {
       forward1();
       s=1;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
       else if(c=='k'&m==1)
      {
        backward1();s=1;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
       else if(c=='g'&m==1)
      {
        left1();s=1;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
      else if(c=='h'&m==1)
      {
       right1();s=1;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
    
      else if(c=='c'&m==1)
      {
        leftturn1(); s=1;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
      else if(c=='d'&m==1)
      {
        rightturn1(); s=1;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
       if(c=='e'&m==2)
      {
       forward2();s=1;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
       s=0;
      }
       else if(c=='k'&m==2)
      {
        backward2();s=0;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
       else if(c=='g'&m==2)
      {
        left2();s=0;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
      else if(c=='h'&m==2)
      {
       right2();s=1;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
    
      else if(c=='c'&m==2)
      {
        leftturn2();s=0;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
      else if(c=='d'&m==2)
      {
        rightturn2();s=0;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
        else if(c=='i')
      {
        up(); s=0;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
        else if(c=='j')
      {
        down(); s=0;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
        else if((c=='b')&&(!i))
      {  Serial.println("index");
        index(); s=0;j=0;s0=0;s90=0;m1=0;m2=0;
      
      }
   else if(c=='m'&&(j==0))
     {  
    unwind();s=0;i=0;s0=0;s90=0; m1=0;m2=0;   
     }
       else if(c=='f')
      {
        grip();s=0;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
       else if(c=='l')
      {
        ungrip();s=0;i=0;j=0;s0=0;s90=0;m1=0;m2=0;
      }
       else if(c=='n'&&(m==1)&&(m2==0))
      {
       ...
       else if(c=='a'&flap==90&s0==0)
      {
        ...
        delay(1000);
        flap=0;
        i=0;j=0;s=0;s0=1;s90=1;m1=0;m2=0;
       ...
       else if(c=='a'&flap==0&s90==0)
      {
        ...
        delay(1000);
        flap=90;
        i=0;j=0;s=0;s90=1;s0=1;m1=0;m2=0;
