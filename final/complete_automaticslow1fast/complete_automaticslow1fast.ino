...
int wspeed=150;
int wspeed2=80;
double release_val1 = 60450;//60400
double release_val2 = 60300;
double release_val3 = 60800;//
double pwm_val = 0;
char r_dir=0;
...
sring=0;
  ...
  {
  case 0 :              
                          for(int ti=millis();millis()<ti+8000;)
                         {
                          myPID.Compute();
                          setPWM(pwm_val);
                           Serial.println("open"); 
                        ...
                        // open valve when reached
                          ...
                          delay(1000);
                           reqd_pos = -3000; 
                           for(int ti=millis();millis()<ti+500;)
                         {
                          myPID.Compute();
                          setPWM(pwm_val);
                         }
