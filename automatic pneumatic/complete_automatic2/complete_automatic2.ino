...
int sp5=150;
int tspeed=100;
double release_val1 = 60200;
double release_val2 = 60150;
double release_val3 = 60200;
double pwm_val = 0;
char r_dir=0;
  ...
  int x=1;int y=(-1);int z=(-1);int w=1;
   ...
   {Serial.print(encoderValue1); Serial.print("/");Serial.print(encoderValue2);Serial.print("/");Serial.print(encoderValue3);Serial.print("/");Serial.print(encoderValue4);Serial.print("/");Serial.print(a);Serial.print("/");Serial.print(b);Serial.print("/");Serial.print(c);Serial.print("/");Serial.println(d);
         
     {
      ...
      { 
       pid1=abs((encoderValue1)*x-a2bd)/66;
       if(pid1>150)
        pid1=150;
         if((pid1<50)&(pid1>10))
        pid1=50;
   ...
   if((encoderValue1)*x<(a2bd+200)&(encoderValue1)*x>(a2bd-200)&val1<(a2bd+200)&val1>(a2bd-200))
     ...
     
    {
      ...
      { 
       pid2=abs(encoderValue2*y-a2bd)/66;
       if(pid2>150)
        pid2=150;
         if((pid2<50)&(pid2>10))
        pid2=50;
   ...
   if(((encoderValue2)*y)<(a2bd+500)&((encoderValue2)*y)>(a2bd-500)&val2<(a2bd+500)&val2>(a2bd-500))
    { 
...

     {
      ...
      { 
       pid3=abs(encoderValue3*z-a2bd)/66;
       if(pid3>150)
        pid3=150;
         if((pid3<50)&(pid3>10))
        pid3=50;
   ...
   if(encoderValue3*z<(a2bd+500)&encoderValue3*z>(a2bd-500)&val3<(a2bd+500)&val3>(a2bd-500))
    { 
  ...
  }
     {
      ...
      { 
       pid4=abs((encoderValue4*w)-a2bd)/66;
       if(pid4>150)
        pid4=150;
         if((pid4<50)&(pid4>10))
        pid4=50;
  ...
  int x=1;int y=(1);int z=(-1);int w=(-1);
   ...
   {Serial.print(encoderValue1); Serial.print("/");Serial.print(encoderValue2);Serial.print("/");Serial.print(encoderValue3);Serial.print("/");Serial.print(encoderValue4);Serial.print("/");Serial.print(a);Serial.print("/");Serial.print(b);Serial.print("/");Serial.print(c);Serial.print("/");Serial.println(d);
       ...
       
     {
      ...
      { 
       pid1=abs((encoderValue1)*x-b2cd)/66;
       if(pid1>150)
        pid1=150;
         if((pid1<50)&(pid1>10))
        pid1=50;
   ...
   if((encoderValue1)*x<(b2cd+200)&(encoderValue1)*x>(b2cd-200)&val1<(b2cd+200)&val1>(b2cd-200))
     ...
     
    {
      ...
      { 
       pid2=abs(encoderValue2*y-b2cd)/66;
       if(pid2>150)
        pid2=150;
         if((pid2<50)&(pid2>10))
        pid2=50;
   ...
   if(((encoderValue2)*y)<(b2cd+500)&((encoderValue2)*y)>(b2cd-500)&val2<(b2cd+500)&val2>(b2cd-500))
    { 
...

     {
      ...
      { 
       pid3=abs(encoderValue3*z-b2cd)/66;
       if(pid3>150)
        pid3=150;
         if((pid3<50)&(pid3>10))
        pid3=50;
   ...
   if(encoderValue3*z<(b2cd+500)&encoderValue3*z>(b2cd-500)&val3<(b2cd+500)&val3>(b2cd-500))
    { 
  ...
  }
     {
      ...
      { 
       pid4=abs((encoderValue4*w)-b2cd)/66;
       if(pid4>150)
        pid4=150;
         if((pid4<50)&(pid4>10))
        pid4=50;
...
void c2b()
{
   ...
   {Serial.print(encoderValue1); Serial.print("/");Serial.print(encoderValue2);Serial.print("/");Serial.print(encoderValue3);Serial.print("/");Serial.print(encoderValue4);Serial.print("/");Serial.print(a);Serial.print("/");Serial.print(b);Serial.print("/");Serial.print(c);Serial.print("/");Serial.println(d);
    if(armpos==0)
       ...
       
     {
      ...
      { 
       pid1=abs((encoderValue1)*x-c2bd)/66;
       if(pid1>150)
        pid1=150;
         if((pid1<50)&(pid1>10))
        pid1=50;
   ...
   if((encoderValue1)*x<(c2bd+200)&(encoderValue1)*x>(c2bd-200)&val1<(c2bd+200)&val1>(c2bd-200))
     ...
     
    {
      ...
      { 
       pid2=abs(encoderValue2*y-c2bd)/66;
       if(pid2>150)
        pid2=150;
         if((pid2<50)&(pid2>10))
        pid2=50;
   ...
   if(((encoderValue2)*y)<(c2bd+500)&((encoderValue2)*y)>(c2bd-500)&val2<(c2bd+500)&val2>(c2bd-500))
    { 
...

     {
      ...
      { 
       pid3=abs(encoderValue3*z-c2bd)/66;
       if(pid3>150)
        pid3=150;
         if((pid3<50)&(pid3>10))
        pid3=50;
   ...
   if(encoderValue3*z<(c2bd+500)&encoderValue3*z>(c2bd-500)&val3<(c2bd+500)&val3>(c2bd-500))
    { 
  ...
  }
     {
      ...
      { 
       pid4=abs((encoderValue4*w)-c2bd)/66;
       if(pid4>150)
        pid4=150;
         if((pid4<50)&(pid4>10))
        pid4=50;
...
void b2d()
{
   ...
   {Serial.print(encoderValue1); Serial.print("/");Serial.print(encoderValue2);Serial.print("/");Serial.print(encoderValue3);Serial.print("/");Serial.print(encoderValue4);Serial.print("/");Serial.print(a);Serial.print("/");Serial.print(b);Serial.print("/");Serial.print(c);Serial.print("/");Serial.println(d);
       ...
       
     {
      ...
      { 
       pid1=abs((encoderValue1)*x-b2dd)/66;
       if(pid1>150)
        pid1=150;
         if((pid1<50)&(pid1>10))
        pid1=50;
   ...
   if((encoderValue1)*x<(b2dd+200)&(encoderValue1)*x>(b2dd-200)&val1<(b2dd+200)&val1>(b2dd-200))
     ...
     
    {
      ...
      { 
       pid2=abs(encoderValue2*y-b2dd)/66;
       if(pid2>150)
        pid2=150;
         if((pid2<50)&(pid2>10))
        pid2=50;
   ...
   if(((encoderValue2)*y)<(b2dd+500)&((encoderValue2)*y)>(b2dd-500)&val2<(b2dd+500)&val2>(b2dd-500))
    { 
...

     {
      ...
      { 
       pid3=abs(encoderValue3*z-b2dd)/66;
       if(pid3>150)
        pid3=150;
         if((pid3<50)&(pid3>10))
        pid3=50;
   ...
   if(encoderValue3*z<(b2dd+500)&encoderValue3*z>(b2dd-500)&val3<(b2dd+500)&val3>(b2dd-500))
    { 
  ...
  }
     {
      ...
      { 
       pid4=abs((encoderValue4*w)-b2dd)/66;
       if(pid4>150)
        pid4=150;
         if((pid4<50)&(pid4>10))
        pid4=50;
...
void d2e()
{
   ...
   {Serial.print(encoderValue1); Serial.print("/");Serial.print(encoderValue2);Serial.print("/");Serial.print(encoderValue3);Serial.print("/");Serial.print(encoderValue4);Serial.print("/");Serial.print(a);Serial.print("/");Serial.print(b);Serial.print("/");Serial.print(c);Serial.print("/");Serial.println(d);
       ...
       
     {
      ...
      { 
       pid1=abs((encoderValue1)*x-d2ed)/66;
       if(pid1>150)
        pid1=150;
         if((pid1<50)&(pid1>10))
        pid1=50;
   ...
   if((encoderValue1)*x<(d2ed+200)&(encoderValue1)*x>(d2ed-200)&val1<(d2ed+200)&val1>(d2ed-200))
     ...
     
    {
      ...
      { 
       pid2=abs(encoderValue2*y-d2ed)/66;
       if(pid2>150)
        pid2=150;
         if((pid2<50)&(pid2>10))
        pid2=50;
   ...
   if(((encoderValue2)*y)<(d2ed+500)&((encoderValue2)*y)>(d2ed-500)&val2<(d2ed+500)&val2>(d2ed-500))
    { 
...

     {
      ...
      { 
       pid3=abs(encoderValue3*z-d2ed)/66;
       if(pid3>150)
        pid3=150;
         if((pid3<50)&(pid3>10))
        pid3=50;
   ...
   if(encoderValue3*z<(d2ed+500)&encoderValue3*z>(d2ed-500)&val3<(d2ed+500)&val3>(d2ed-500))
    { 
  ...
  }
     {
      ...
      { 
       pid4=abs((encoderValue4*w)-d2ed)/66;
       if(pid4>150)
        pid4=150;
         if((pid4<50)&(pid4>10))
        pid4=50;
...
void e2d()
{
  ...
  if(armpos==0)
                      ...
                      }
     {
      ...
      { 
       pid1=abs((encoderValue1)*x-e2dd)/66;
       if(pid1>150)
        pid1=150;
         if((pid1<50)&(pid1>10))
        pid1=50;
   ...
   if((encoderValue1)*x<(e2dd+200)&(encoderValue1)*x>(e2dd-200)&val1<(e2dd+200)&val1>(e2dd-200))
     ...
     
    {
      ...
      { 
       pid2=abs(encoderValue2*y-e2dd)/66;
       if(pid2>150)
        pid2=150;
         if((pid2<50)&(pid2>10))
        pid2=50;
   ...
   if(((encoderValue2)*y)<(e2dd+500)&((encoderValue2)*y)>(e2dd-500)&val2<(e2dd+500)&val2>(e2dd-500))
    { 
...

     {
      ...
      { 
       pid3=abs(encoderValue3*z-e2dd)/66;
       if(pid3>150)
        pid3=150;
         if((pid3<50)&(pid3>10))
        pid3=50;
   ...
   if(encoderValue3*z<(e2dd+500)&encoderValue3*z>(e2dd-500)&val3<(e2dd+500)&val3>(e2dd-500))
    { 
  ...
  }
     {
      ...
      { 
       pid4=abs((encoderValue4*w)-e2dd)/66;
       if(pid4>150)
        pid4=150;
         if((pid4<50)&(pid4>10))
        pid4=50;
...
void d2f()
{
   ...
   {Serial.print(encoderValue1); Serial.print("/");Serial.print(encoderValue2);Serial.print("/");Serial.print(encoderValue3);Serial.print("/");Serial.print(encoderValue4);Serial.print("/");Serial.print(a);Serial.print("/");Serial.print(b);Serial.print("/");Serial.print(c);Serial.print("/");Serial.println(d);
       ...
       
     {
      ...
      { 
       pid1=abs((encoderValue1)*x-d2fd)/66;
       if(pid1>150)
        pid1=150;
         if((pid1<50)&(pid1>10))
        pid1=50;
   ...
   if((encoderValue1)*x<(d2fd+200)&(encoderValue1)*x>(d2fd-200)&val1<(d2fd+200)&val1>(d2fd-200))
     ...
     
    {
      ...
      { 
       pid2=abs(encoderValue2*y-d2fd)/66;
       if(pid2>150)
        pid2=150;
         if((pid2<50)&(pid2>10))
        pid2=50;
   ...
   if(((encoderValue2)*y)<(d2fd+500)&((encoderValue2)*y)>(d2fd-500)&val2<(d2fd+500)&val2>(d2fd-500))
    { 
...

     {
      ...
      { 
       pid3=abs(encoderValue3*z-d2fd)/66;
       if(pid3>150)
        pid3=150;
         if((pid3<50)&(pid3>10))
        pid3=50;
   ...
   if(encoderValue3*z<(d2fd+500)&encoderValue3*z>(d2fd-500)&val3<(d2fd+500)&val3>(d2fd-500))
    { 
  ...
  }
     {
      ...
      { 
       pid4=abs((encoderValue4*w)-d2fd)/66;
       if(pid4>150)
        pid4=150;
         if((pid4<50)&(pid4>10))
        pid4=50;
...
void f2d()
{
   ...
   {Serial.print(encoderValue1); Serial.print("/");Serial.print(encoderValue2);Serial.print("/");Serial.print(encoderValue3);Serial.print("/");Serial.print(encoderValue4);Serial.print("/");Serial.print(a);Serial.print("/");Serial.print(b);Serial.print("/");Serial.print(c);Serial.print("/");Serial.println(d);
       ...
       
     {
      ...
      { 
       pid1=abs((encoderValue1)*x-f2dd)/66;
       if(pid1>150)
        pid1=150;
          if((pid1<50)&(pid1>10))
        pid1=50;
   ...
   if((encoderValue1)*x<(f2dd+200)&(encoderValue1)*x>(f2dd-200)&val1<(f2dd+200)&val1>(f2dd-200))
     ...
     
    {
      ...
      { 
       pid2=abs(encoderValue2*y-f2dd)/66;
       if(pid2>150)
        pid2=150;
          if((pid2<50)&(pid2>10))
        pid2=50;
   ...
   if(((encoderValue2)*y)<(f2dd+500)&((encoderValue2)*y)>(f2dd-500)&val2<(f2dd+500)&val2>(f2dd-500))
    { 
...

     {
      ...
      { 
       pid3=abs(encoderValue3*z-f2dd)/66;
       if(pid3>150)
        pid3=150;
          if((pid3<50)&(pid3>10))
        pid3=50;
   ...
   if(encoderValue3*z<(f2dd+500)&encoderValue3*z>(f2dd-500)&val3<(f2dd+500)&val3>(f2dd-500))
    { 
  ...
  }
     {
      ...
      { 
       pid4=abs((encoderValue4*w)-f2dd)/66;
       if(pid4>150)
        pid4=150;
          if((pid4<50)&(pid4>10))
        pid4=50;
...
void calib1()
{
 ...
 Serial.print(us1()); Serial.print("/");Serial.println(us2());
  ...
  if((us1()<245)&(us2()<245))
  {
    ...
    if(((us1()<255|us1()>245)&(us2()<255|us2()>245))&(abs(us1()-us2())>5))
   {
     if(us1()>us2())
    { 
    leftturn();
...
if(d1<1553&d1>1548&d2<1553&d2>1548)
break;
...
while(us2()>3343|us4()<3337)
{
  d1=us2();
Serial.print("d1///");Serial.println(us2());
if(us2()>3343)
{left();
delay(50);
Serial.println("left");
...
if((us2()>3337)&(us2()<3343))
{off();Serial.println("off");
delay(50);
}

d2=us2();
Serial.print("d2////");Serial.println(us2());
if(d1<3343&d1>3337&d2<3343&d2>3337)
break;
...
d2=us4();
Serial.print("d2////");Serial.println(us4());
if(d1<1505&d1>1495&d2<1505&d2>1495)
break;
