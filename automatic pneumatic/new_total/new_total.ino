...
int sp5=150;
int tspeed=50;
double release_val1 = 60300;
double release_val2 = 60400;
double release_val3 = 60100;
double pwm_val = 0;
char r_dir=0;
...
//                        stringComplete = true;
            ...
            case 1:    for(int ti=millis();millis()<ti+1000;)
                         {myPID.Compute();
                          setPWM(pwm_val);
                         }
                        // open valve when reached
                        if(encoderValue5 < -2000 && encoderValue5 > -3000)
                        {   Serial.println("open"); 
...
void wall()
{
   analogWrite(pwm1,80);//m1
    analogWrite(pwm2,80);//m2
     analogWrite(pwm3,80);//m1
    analogWrite(pwm4,80);//m2
